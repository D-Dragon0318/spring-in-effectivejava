...
public class demo {
	public static void main(String[] args) {
		...
		leaderboard.addScore("player1", 500, counter.incrementAndGet());
		leaderboard.addScore("player2", 400, counter.incrementAndGet());
		leaderboard.addScore("player3", 450, counter.incrementAndGet());
